...
const SkillSection = () => {
  return (
    <section className="relative  mx-auto   w-full max-w-[1110px] px-4  ">
      <div className="absolute -bottom-[65px] -right-[358px] md:top-[387px] md:-right-[362px] sl:-right-[404px] sl:top-[253px]  ">
        <Image
          src={patternRing}
          alt=""
          width={530}
