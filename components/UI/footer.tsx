    ...
    <div className="">
      <footer className=" relative flex max-w-[1440px] flex-col justify-center bg-dark-grey px-4  pt-[60px] md:px-[30px]  sl:px-[165px] ">
        ...
        <div className="mt-[87px] ">
          <nav className=" border-t  pt-[39px] pb-[60px] md:pb-[40px] md:pt-[30px]">
            <div className=" flex flex-col items-center space-y-6 md:flex-row md:justify-between ">
              ...
              <div className=" z-50   flex items-center space-x-[1.625rem] md:space-x-8">
                <div className=" h-5 w-5 cursor-pointer fill-white hover:fill-green md:h-6 md:w-6">
                  <svg
